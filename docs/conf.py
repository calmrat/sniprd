# -*- coding: utf-8 -*-
#
# snipcatch documentation build configuration file, created by
...
htmlhelp_basename = 'snipcatchdoc'
...
man_pages = [
    (master_man, 'snipcatch', u'snipcatch Documentation',
     [author], 1)
]
